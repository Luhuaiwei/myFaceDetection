...
//      // outputMask contains zeros and ones indicating which matches are filtered
        ...
        Highgui.imwrite("D:\\picture\\result.jpg", outputImg);
        Highgui.imwrite("D:\\picture\\result2.jpg", outputImg2);
    }
    ...
    public  static void lhw()
    {
        Mat scene=Highgui.imread("D:\\picture\\login\\image_final.jpg");//参考  
        Mat object=Highgui.imread("D:\\picture\\register\\1526842578536\\image_final.jpg");//调整目标
        ...
        Highgui.imwrite("D:\\picture\\scene.jpg",scene);//调整目标
        Highgui.imwrite("D:\\picture\\object.jpg",object);//调整目标
        //tiaozheng(scene,object);
        //tiaozheng(img1,img2);
        tiaozheng2(img1,img2);
        //tiaozheng2(scene,object);
        Highgui.imwrite("D:\\picture\\object2.jpg",object);
    }
}